...
const ResultPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchAnimeData = async () => {
      ...
      // Mock anime data
      setAnimeData({
        title: animeTitle || "Attack on Titan",
        alternativeTitle: "Shingeki no Kyojin",
        synopsis: "Humanity fights for survival against giant humanoid Titans. Behind massive walls, the last remnants of humanity struggle against these mysterious creatures that appear to have no other purpose than consuming humans.",
        ...
        rating: "9.0/10",
        status: "Completed",
        posterUrl: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=600&fit=crop&crop=faces",
        externalLinks: {
          myAnimeList: "https://myanimelist.net/anime/16498/Shingeki_no_Kyojin",
          aniList: "https://anilist.co/anime/16498/Shingeki-no-Kyojin"
        }
      });
